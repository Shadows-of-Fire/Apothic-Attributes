...
public class ALObjects {
    ...
    public static class Attributes {
         ...
         */
        public static final Supplier<Attribute> ARMOR_PIERCE = R.attribute("armor_pierce", () -> new RangedAttribute("attributeslib:armor_pierce", 0.0D, 0.0D, 1000.0D).setSyncable(true));

        /**
         * Percentage armor reduction. Base value = (0.0) = 0% of armor reduced during damage calculations.
         */
        public static final Supplier<Attribute> ARMOR_SHRED = R.attribute("armor_shred", () -> new PercentBasedAttribute("attributeslib:armor_shred", 0.0D, 0.0D, 2.0D).setSyncable(true));

        /**
         * Arrow Damage. Base value = (1.0) = 100% default arrow damage
         */
        public static final Supplier<Attribute> ARROW_DAMAGE = R.attribute("arrow_damage", () -> new PercentBasedAttribute("attributeslib:arrow_damage", 1.0D, 0.0D, 10.0D).setSyncable(true));
         ...
         */
        public static final Supplier<Attribute> ARROW_VELOCITY = R.attribute("arrow_velocity", () -> new PercentBasedAttribute("attributeslib:arrow_velocity", 1.0D, 0.0D, 10.0D).setSyncable(true));

        /**
         * Bonus magic damage that slows enemies hit. Base value = (0.0) = 0 damage
         */
        public static final Supplier<Attribute> COLD_DAMAGE = R.attribute("cold_damage", () -> new RangedAttribute("attributeslib:cold_damage", 0.0D, 0.0D, 1000.0D).setSyncable(true));
         ...
         */
        public static final Supplier<Attribute> CRIT_CHANCE = R.attribute("crit_chance", () -> new PercentBasedAttribute("attributeslib:crit_chance", 0.05D, 0.0D, 10.0D).setSyncable(true));
         ...
         */
        public static final Supplier<Attribute> CRIT_DAMAGE = R.attribute("crit_damage", () -> new PercentBasedAttribute("attributeslib:crit_damage", 1.5D, 1.0D, 100.0D).setSyncable(true));

        /**
         * Bonus physical damage dealt equal to enemy's current health. Base value = (0.0) = 0%
         */
        public static final Supplier<Attribute> CURRENT_HP_DAMAGE = R.attribute("current_hp_damage", () -> new PercentBasedAttribute("attributeslib:current_hp_damage", 0.0D, 0.0D, 1.0D).setSyncable(true));
         ...
         */
        public static final Supplier<Attribute> DODGE_CHANCE = R.attribute("dodge_chance", () -> new PercentBasedAttribute("attributeslib:dodge_chance", 0.0D, 0.0D, 1.0D).setSyncable(true));

        /**
         * How fast a ranged weapon is charged. Base Value = (1.0) = 100% default draw speed.
         */
        public static final Supplier<Attribute> DRAW_SPEED = R.attribute("draw_speed", () -> new PercentBasedAttribute("attributeslib:draw_speed", 1.0D, 0.0D, 4.0D).setSyncable(true));

        /**
         * Experience mulitplier, from killing mobs or breaking ores. Base value = (1.0) = 100% xp gained.
         */
        public static final Supplier<Attribute> EXPERIENCE_GAINED = R.attribute("experience_gained", () -> new PercentBasedAttribute("attributeslib:experience_gained", 1.0D, 0.0D, 1000.0D).setSyncable(true));

        /**
         * Bonus magic damage that burns enemies hit. Base value = (0.0) = 0 damage
         */
        public static final Supplier<Attribute> FIRE_DAMAGE = R.attribute("fire_damage", () -> new RangedAttribute("attributeslib:fire_damage", 0.0D, 0.0D, 1000.0D).setSyncable(true));

        /**
         * Extra health that regenerates when not taking damage. Base value = (0.0) = 0 damage
         */
        public static final Supplier<Attribute> GHOST_HEALTH = R.attribute("ghost_health", () -> new RangedAttribute("attributeslib:ghost_health", 0.0D, 0.0D, 1000.0D).setSyncable(true));

        /**
         * Adjusts all healing received. Base value = (1.0) = 100% xp gained.
         */
        public static final Supplier<Attribute> HEALING_RECEIVED = R.attribute("healing_received", () -> new PercentBasedAttribute("attributeslib:healing_received", 1.0D, 0.0D, 1000.0D).setSyncable(true));

        /**
         * Percent of physical damage converted to health. Base value = (0.0) = 0%
         */
        public static final Supplier<Attribute> LIFE_STEAL = R.attribute("life_steal", () -> new PercentBasedAttribute("attributeslib:life_steal", 0.0D, 0.0D, 10.0D).setSyncable(true));

        /**
         * Mining Speed. Base value = (1.0) = 100% default break speed
         */
        public static final Supplier<Attribute> MINING_SPEED = R.attribute("mining_speed", () -> new PercentBasedAttribute("attributeslib:mining_speed", 1.0D, 0.0D, 10.0D).setSyncable(true));

        /**
         * Percent of physical damage converted to absorption hearts. Base value = (0.0) = 0%
         */
        public static final Supplier<Attribute> OVERHEAL = R.attribute("overheal", () -> new PercentBasedAttribute("attributeslib:overheal", 0.0D, 0.0D, 10.0D).setSyncable(true));

        /**
         * Flat protection penetration. Base value = (0.0) = 0 protection points bypassed during damage calculations.
         */
        public static final Supplier<Attribute> PROT_PIERCE = R.attribute("prot_pierce", () -> new RangedAttribute("attributeslib:prot_pierce", 0.0D, 0.0D, 34.0D).setSyncable(true));

        /**
         * Percentage protection reduction. Base value = (0.0) = 0% of protection points bypassed during damage calculations.
         */
        public static final Supplier<Attribute> PROT_SHRED = R.attribute("prot_shred", () -> new PercentBasedAttribute("attributeslib:prot_shred", 0.0D, 0.0D, 1.0D).setSyncable(true));
    ...
    public static final class Potions {
        ...
        public static final Supplier<Potion> STRONG_KNOWLEDGE = R.singlePotion("strong_knowledge", () -> new MobEffectInstance(ALObjects.MobEffects.KNOWLEDGE.get(), 1200, 1));
