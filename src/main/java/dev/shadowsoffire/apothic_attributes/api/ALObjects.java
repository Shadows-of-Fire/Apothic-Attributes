...
public class ALObjects {
    ...
    public static class Attributes {
         ...
         */
        public static final Holder<Attribute> COOLDOWN_REDUCTION = R.attribute("cooldown_reduction", () -> new PercentageAttribute("apothic_attributes:cooldown_reduction", 0.0D, -10.0D, 0.95D).setSyncable(true));
